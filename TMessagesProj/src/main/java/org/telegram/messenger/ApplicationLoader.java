...
public class ApplicationLoader extends Application {
    ...
    public static void startPushService() {
        ...
        if (preferences.contains("pushService")) {
            ...
            // No FCM/HMS in this build - default to the always-on MTProto
            // keep-alive connection so notifications still arrive in the
            // background, instead of inheriting the upstream "false" default
            // that assumed a third-party push channel would be available.
