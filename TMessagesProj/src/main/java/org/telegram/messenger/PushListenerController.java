...
public class PushListenerController {
    ...
    /**
     * Firebase Cloud Messaging support has been removed from this build.
     * This provider always reports hasServices() == false, which makes
     * ApplicationLoader.initPushServices() register a null push token with
     * the server and fall back to org.telegram.messenger.NotificationsService
     * (a foreground service holding the MTProto connection open) for
     * real-time delivery instead of a third-party push channel.
     */
    public final static class NoPushListenerServiceProvider implements IPushListenerServiceProvider {
        ...
        public String getLogTitle() {
            return "MTProto (no third-party push)";
        }
        ...
        public void onRequestPushToken() {
            // no-op: no push token to request
        }
