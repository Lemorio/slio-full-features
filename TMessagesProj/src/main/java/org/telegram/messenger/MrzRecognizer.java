...
public class MrzRecognizer {
	...
	private static Result recognizeBarcode(Bitmap bitmap) {
		// GMS Vision BarcodeDetector removed from this build. This path only
		// ever handled two edge cases - North American PDF417 driver's
		// license/ID barcodes, and one undocumented Russian driver's license
		// barcode format - not passport/ID MRZ scanning itself, which is
		// handled natively by recognizeMRZ() below and is unaffected.
		return null;
	}
